...
<html>
   ...
   <div id="edit" class="w3-modal">
         <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
            ...
            <form class="w3-container" action="/savmhs" method = "POST">
              {{ csrf_field() }}
              <input type="hidden" id="edit_id" name="edit_id">
               <div class="w3-section">
                  <div class="w3-row">
                     <div class="w3-col s4"><label><b>NRP</b></label></div>
                     <div class="w3-col s8"><input class="w3-input w3-border w3-margin-bottom" id="nrp" type="text" placeholder="Enter Nrp" name="nrp" required>
                     </div>
                  </div>
                  <div class="w3-row">
                     <div class="w3-col s4">
                     ...
                     <div class="w3-col s8"><input class="w3-input w3-border w3-margin-bottom" id="namamhs" type="text" placeholder="Enter Nama Mahasiswa" name="namamhs" required></div>
                  </div>
      ...
      <div id="delete" class="w3-modal">
         <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
            ...
            <form class="w3-container" action="/delmhs" method="POST">
              {{ csrf_field() }}
         ...
         $( document ).ready(function(){
           $("#grid-basic").bootgrid({
             formatters: {
               ...
               {
                 return "<button onclick=\"document.getElementById('edit').style.display='block'\" data-id=\"" + row.id + "\" data-nrp=\"" + row.nrp + "\" data-namamhs=\"" + row.namamhs + "\" class=\"w3-btn w3-blue w3-small edit\"><span class=\"fa fa-pencil\"></span></button> " +
                 "<button onclick=\"document.getElementById('delete').style.display='block'\" data-nrp=\"" + row.nrp + "\" data-namamhs=\"" + row.namamhs  + "\" class=\"w3-btn w3-blue w3-small delete\"><span class=\"fa fa-remove\"></span></button>";
               }
             }}).on("loaded.rs.jquery.bootgrid", function (){
               /* Executes after data is loaded and rendered */
               $(this).find(".edit").click(function (e) {
                 $('#edit_id').val($(this).data("nrp"));
                 $('#nrp').val($(this).data("nrp"));
                 $('#namamhs').val($(this).data("namamhs"));
                 
               });
               $(this).find(".delete").click(function (e) {
                 $('#del_id').val($(this).data("nrp"));
                 $('#delete_name').html($(this).data("nrp") +" "+ $(this).data("namamhs"));
               });
             });
           });
      </script>
