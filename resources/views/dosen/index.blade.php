    ...
    <div class="panel-body">
        ...
        <div class=row>
            <div class="col-md-6">
                ...
                <a href="/viewdosen" class="btn btn-primary"><i class="fa fa-refresh"></i> BootGird</a>
            </div>
            <div class="col-md-2">
            </div>
            <div class="col-md-4">
              {{Form::open(['method'=>'GET','url'=>'caridosen','role'=>'search'])}}
                <div class="input-group custom-search-form">
                    <input type="text" class="form-control" name="search" placeholder="Search Nama Dosen...">
                   ...
                   @foreach($dsn as $m)
                       <tr>
                           ...
                           <td align="center" width="30px">
                             <a href="/dosen/listmhs/{{$m->nip}}" class="btn btn-success btn-sm" role="button"><i class="fa fa-pencil-square"> Detail Anak Wali</i></a>
                           </td>
                           <td align="center" width="30px">
